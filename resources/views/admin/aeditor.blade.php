        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Список опубликованных статей</strong>
                    <div class="block-body text-right">
                      <a class="btn btn-secondary" href="/amonitor/addarticle" role="button">Добавление заметок!</a>
                      <a class="btn btn-warning" href="/aeditor" role="button">Редактор статей!</a>
                    </div>
                  </div>
